...
exports.generateSetorCode = generateSetorCode;
exports.generatePenukaranCode = generatePenukaranCode;
exports.generateVoucherCode = generateVoucherCode;
function generateSetorCode(counter) {
    const date = new Date();
...
function generatePenukaranCode(counter) {
    const date = new Date();
    const year = date.getFullYear();
    const month = String(date.getMonth() + 1).padStart(2, '0');
    const num = String(counter).padStart(4, '0');
