...
export declare class SetorSampahService {
    private prisma;
    constructor(prisma: PrismaService);
    createPengajuan(appMakerId: string, nasabahId: string, dto: CreateSetorSampahDto, fotoBuktiUrl?: string): Promise<{
        message: string;
        data: {
            id: string;
            kodeSetor: string;
    ...
    getMySetor(appMakerId: string, nasabahId: string, bulan?: string): Promise<{
        message: string;
        data: {
            id: string;
            kodeSetor: string;
    ...
    getDetail(appMakerId: string, id: string, user: any): Promise<{
        message: string;
        data: {
            id: string;
            kodeSetor: string;
